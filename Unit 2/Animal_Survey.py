...
#summary here ↓↓↓
print("So your favorite animal is " + fav_animal + ". Which lives in " + live_fav_anim + ", where they eat " + diet_fav_anim + ". You like " + fav_animal + "s because " + why_fav_anim + ". They are colored " + color_fav_anim + ". And they make the sound " + sound_fav_anim + ".")
